...
public:
    ...
    // Initialize with C-string
    inline String(const char *buf, size_t length) : __data(buf ? buf : "", length) {}
    ...
    // Splits the string into segments divided by the instances of a given characters in string,
