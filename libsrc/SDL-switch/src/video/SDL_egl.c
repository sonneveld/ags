...
#elif SDL_VIDEO_STATIC_ANGLE
/* no dynamic libraries here. */
...
SDL_EGL_GetProcAddress(_THIS, const char *proc)
{
    ...
    if ((retval == NULL) && (_this->egl_data->egl_dll_handle)) {
...
SDL_EGL_LoadLibrary(_THIS, const char *egl_path, NativeDisplayType native_display, EGLenum platform)
{
    ...
    void *egl_dll_handle = NULL; /* The naming is counter intuitive, but hey, I just work here -- Gabriel */
#endif
...
#ifndef __NINTENDO_SWITCH__  /* this isn't in the Switch SDK. */
